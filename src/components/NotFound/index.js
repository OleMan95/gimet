...
import invaderIcon from '../../data/images/invader.png';
import playerIco from '../../data/images/player.png';
import './index.scss';
    ...
    return (
      <div className="NotFound">
				<div className="py-5 mx-auto">
					<h3 className="text-center">Space Invadors destroyed this page! Take revenge on them!</h3>

					<p className="text-center">
						Use <span className="label label-danger">Space</span> to shoot and
						<i className="ion-arrow-left-c label label-danger"/>
						<i className="ion-arrow-right-c label label-danger"/>
						to move! <button className="btn btn-light btn-xs" id="restart">Restart</button>
					</p>
